...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("g:\\Faculty-Files\\Senior -2- 1st term\\Design of Compilers\\TINY Language Compiler\\TINY_Language_Compiler\\Icon/icons8-code-file-48.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("g:\\Faculty-Files\\Senior -2- 1st term\\Design of Compilers\\TINY Language Compiler\\TINY_Language_Compiler\\Icon/warning.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.problemsButton.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("g:\\Faculty-Files\\Senior -2- 1st term\\Design of Compilers\\TINY Language Compiler\\TINY_Language_Compiler\\Icon/question.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.helpButton.setIcon(icon8)
        self.helpButton.setObjectName("helpButton")
        self.gridLayout.addWidget(self.helpButton, 0, 1, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(10, 530, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout.addItem(spacerItem1, 1, 1, 4, 1)
